import 'dart:convert';
import 'dart:io';
import 'package:chandrakalm/Screens/gift_course_screen.dart';
import 'package:chandrakalm/model/course_with_progress.dart';
...
import 'package:chandrakalm/player/playlist_screen.dart';
...
class _CourseDetailMenuScreenState extends State<CourseDetailMenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (compareCourseProvider!.compareCourseModel != null) {
      compareId =
