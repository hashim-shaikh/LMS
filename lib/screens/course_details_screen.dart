...
import 'package:chandrakalm/Screens/rate_course_screen.dart';
import 'package:chandrakalm/Widgets/videoplayer.dart';
import 'package:chandrakalm/common/global.dart';
import 'package:chandrakalm/model/purchase_history_model.dart';
...
class _CourseDetailScreenState extends State<CourseDetailScreen>
  ...
  Future<Instructor> getinstdata(dynamic id) async {
    ...
    if (res.statusCode == 200) {
      ...
      print(
          "Instructor API Status Code :-> ${APIData.instructorProfile}${APIData.secretKey}");
      print("Instructor API Status Code2 :-> ${id}");
      throw "err";
    }
              ...
              children: [
                ...
                Expanded(
                    child: fun(
                        ...
                        DateFormat.yMMMd()
                            .format(details.course?.createdAt as DateTime))),
                Expanded(
                    child: fun(
                        translate("Language_"),
      ...
      child:
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                  child: funcol(translate("Course_By"),
  ...
  Widget scaffoldBody(
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          FullCourse details = snapshot.data as FullCourse;
