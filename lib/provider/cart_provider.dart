...
import 'package:chandrakalm/model/my_cart.dart';
import 'package:chandrakalm/provider/bundle_course.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:provider/provider.dart';
import 'courses_provider.dart';
import 'package:chandrakalm/model/course.dart';
import 'package:chandrakalm/model/bundle_courses_model.dart';
  ...
  int get cartTotal {
    ...
    cartCourseList!.forEach((element) {
      if (element.discountPrice == null)
        ...
        tPrice += num.tryParse(element.discountPrice)!.round();
    });
    cartBundleList!.forEach((element) {
      if (element.discountPrice == null)
        tPrice += num.tryParse(element.price)!.round();
      else if (checkDataType(element.discountPrice) == 0)
        tPrice += num.tryParse(element.price)!.round();
      else
        tPrice += num.tryParse(element.discountPrice)!.round();
