...
import 'dart:convert';
import 'dart:io';
import 'package:chandrakalm/Screens/loading_screen.dart';
import 'package:chandrakalm/Widgets/appbar.dart';
import 'package:chandrakalm/Widgets/credit_card_form.dart';
import 'package:chandrakalm/Widgets/credit_card_model.dart';
import 'package:chandrakalm/Widgets/credit_card_widget.dart';
import 'package:chandrakalm/Widgets/profile_tile.dart';
import 'package:chandrakalm/Widgets/success_ticket.dart';
...
import 'package:chandrakalm/provider/payment_api_provider.dart';
...
//  Customer is created on stripe for making payment.
  ...
  void _saveCard(customerStripeId) async {
    ...
    var cardExpMonth = int.tryParse(x[0]);
    var cardExpYear = int.tryParse(x[1]);
...
//  Validation alert dialog
  ...
  void onCreditCardModelChange(CreditCardModel? creditCardModel) {
    setState(() {
      cardNumber = creditCardModel!.cardNumber.toString();
      expiryDate = creditCardModel.expiryDate.toString();
      cardHolderName = creditCardModel.cardHolderName.toString();
      cvvCode = creditCardModel.cvvCode.toString();
